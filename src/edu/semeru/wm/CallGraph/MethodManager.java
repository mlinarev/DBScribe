...
public class MethodManager {
	...
	public void addMethod(String m){
		...
		if(methodList == null){
			...
			if(splitm.length > 2){
				methodArgs = splitm[2];
				numOfPara = methodArgs.split(",").length;
			}
			
			Method newMethod = new Method( className, methodName, methodArgs,numOfPara);
			//update key
	 ...
	 * 
	 */
	public void updateDBUsage(String key, MethodQueryVO mvo){
