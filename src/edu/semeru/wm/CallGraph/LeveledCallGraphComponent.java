...
public class LeveledCallGraphComponent {
	 ...
	 */
	public void updateDateDBusageToMM(HashMap<String, MethodQueryVO> methodQueriesMap){

		Iterator<Entry<String, MethodQueryVO>> it = methodQueriesMap.entrySet().iterator();
		while (it.hasNext()) {
			Map.Entry<String, MethodQueryVO> pair = (Map.Entry<String, MethodQueryVO>)it.next();
			String methodFullName = pair.getKey(); 
			MethodQueryVO methodQuery = pair.getValue();
	 ...
	 * run DBScribe
	 */
	public void analyze(HashMap<String, HashSet<String>> methodCalls, HashMap<String, MethodQueryVO> methodQueriesMap, HashSet<String> allMethods){
